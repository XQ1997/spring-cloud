package com.x.orders.service.impl;
...
import com.x.messagesdk.service.MqMessageService;
import com.x.orders.config.PayNotifyConfig;
...
import com.x.orders.model.po.XcOrders;
import com.x.orders.model.po.XcOrdersGoods;
    ...
    public void saveAliPayStatus(PayStatusDto payStatusDto) {
        ...
        if(trade_status.equals("TRADE_SUCCESS")){
            ...
            if(update1>0){
                ...
                //向消息表插入记录，String messageType(标记为支付结果通知),String businessKey1（选课记录id）,String businessKey2(具体订单业务类型),String businessKey3
