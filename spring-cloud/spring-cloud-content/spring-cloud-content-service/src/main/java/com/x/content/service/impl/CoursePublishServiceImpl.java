...
import com.x.content.feignclient.SearchServiceClient;
...
import com.x.content.mapper.CoursePublishMapper;
import com.x.content.mapper.CoursePublishPreMapper;
...
import com.x.content.model.po.CoursePublishPre;
...
public class CoursePublishServiceImpl implements CoursePublishService {
    ...
    public Boolean saveCourseIndex(Long courseId) {
        ...
        if(!result){
            XueChengException.cast("创建课程索引失败");
        }
        return result;
    }
